...
function CreateAccount({ handleAddAccount }) {
  ...
  const handleSendContact = (index) => {
    ...
    const url = `${API_KEY}/common/contact/`;
                  ...
                  {contacts.map((contact, index) => (
                    <div key={index}>
                      <div className="dynamicContact" style={{ padding: "0 10px 0 10px" }}>
                        ...
                        <div key={index} className="contacts-company-name col-12" style={{ padding: "0 10px 0 10px " }}>
                        ...
                        <div className="contacts-zip col-4" style={{ padding: "0 10px 0 10px" }}>
                          ...
                          <input style={{ padding: "8px 12px", width: "100%", border: "2px solid rgb(100, 149, 237)", borderRadius: "10px", margin: "10px 0", }}inputMode="numeric" className="col-4 input" type="number" name="postalCode" id={`postalCode${index}`} value={contact.postalCode} onChange={(e) => handleInputChange(index, e)} />
                        </div>
                        <div className=" col-12">
                          <hr />
                        </div>
      ...
      <div>
        <div className="account-header col-12">
          <h3 className="account_title">New Account</h3>
            ...
            <RxCross2 onClick={() => handleAddAccount()} style={{cursor:'pointer'}}/>
