    ...
    <div className="job-temp-container col-12" style={{ marginLeft: '15px', marginTop: '10px', height: '90vh', overflowY: 'auto' }}>
      <div >
        {!showForm &&
          <div>
            <h1>Job Template</h1>
            <button className='btn1' style={{ marginBottom: '10px' }} onClick={handleCreateTemplate}>Create Template</button>
            <table >
              <thead>
                <tr>
                  <th>Name</th>
          ...
          <div className='job-template-container col-12'>
            <div className='job-template-header' style={{ display: 'flex', justifyContent: 'space-between', margin: '10px' }}>
              ...
              {/* <button className=' col-1' style={{ border: 'none', backgroundColor: '#e4e9f7' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: 'blue', fontSize: '15px', cursor: 'pointer', marginLeft: 'auto' }}>
                  <LuPlusCircle />
                  <span>Add </span>
                </div>
              </button> */}
            ...
            <div className='job-template-form-area'>
              <div className='job-template-create-form col-6' >
                ...
                <div>
                  ...
                  <input style={{ padding: '8px 12px', width: '100%', border: "2px solid rgb(100, 149, 237)", borderRadius: '10px', margin: '10px 0' }} type='text' className='job-input' onChange={(e) => setjobname(e.target.value)} placeholder='Job name' />
                </div>


                {/* <div className='addshortcodes' style={{ color: 'var(--links-background)', cursor: 'pointer' }}>
                  <RiAddCircleLine onClick={toggleDropdown} className="add-shortcut-icon" /> Add Shortcode

                  {showDropdown && (
                    <div className="dropdown" ref={dropdownRef}>
                      <div style={{display:'flex', justifyContent:'space-between', gap:'10px'}} className="search-bar">
                        <input
                          type="text"
            ...
            <div className='bottom-buttons-group col-6' style={{ display: 'flex', gap: '10px', marginLeft: '10px', marginBottom: '20px' }}>
              ...
              <button type='submit' className=' btn1 col-2' onClick={createjobtemp} >Save </button>
              <button type='reset' onClick={handleCancel} className='btn2 col-2'>Cancle</button>
            </div>
            {/* </div> */}
          </div>
        )}
