  ...
  const updatejobtemp = () => {
    ...
    fetch(url + _id, requestOptions)
      ...
      .then((result) => {
        ...
        setTimeout(() => navigate("/job_template"), 1000); 
      })
      .catch((error) => {
        // Handle errors
        console.error(error);
    ...
    <>
      <div className='job-template-container col-12'>
        ...
        <div className='bottom-buttons-group col-6' style={{ display: 'flex', gap: '10px' }}>
          ...
          <button type='submit' className='btn1  ' onClick={updatejobtemp} >Save </button>
          ...
          <button type='reset' onClick={handleCancel} className='btn2'>Cancle</button>
        </div>
        {/* </div> */}
        <ToastContainer />
      </div>
