...
const SignUp = ({ handleSignupPage }) => {
  ...
  const adminalldata = () => {
    ...
    const Url = `${API_KEY}/admin/adminsignup/`;
  ...
  const userCreatedmail = () => {
    ...
    const Url = `${API_KEY}/usersavedemail/`;
    fetch(Url, requestOptions)
